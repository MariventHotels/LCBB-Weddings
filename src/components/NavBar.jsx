...
import logo from "../assets/logos/lasbodaslogowhite.png";
  ...
  return (
    <header
      className={classNames(
        ...
        "sticky top-0 z-[999] block bg-[#804B00] bg-cover transition-shadow"
      )}
    >
      <div
        className="mx-auto flex justify-center z-[999] bg-[#804B00] transition-all text-red"
        style={navbarStyles}
      >
      ...
      <nav className="z-[3] hidden absolute top-1.5 left-4 xmd:flex text-white">
        <Hamburger size={24} onToggle={handleNav} toggled={isOpen} />
      </nav>
     {/**
         <div className="hidden z-[3] absolute top-4 right-4 xmd:flex">
        <Link to="/inquire">
    ...
    */}
      ...
      <ul
        className={classNames(
          ...
          `flex items-center justify-center font-futura tracking-widest text-xs uppercase gap-1 py-4 xmd:flex-col xmd:items-start bg-[#804B00] w-full -z-50 xmd:absolute transition-all duration-1000 ease-in-out ${
