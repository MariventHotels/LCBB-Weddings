...
import img3 from "../assets/gallery/prenup/prenuphero.jpg";
...
const Navigation = () => {
  ...
  return (
    <div className="mb-20 md:mb-5 max-w-[70rem] mx-auto">
      <div className="flex justify-center items-center gap-8 lg:gap-5 xmd:flex-col">
        {images.map((image, index) => (
          ...
          >
            ...
            >
              <ImageHover>
                <img src={image.src} className="object-cover h-[400px] w-[400px] xmd:h-[400px] xmd:w-[300px] xxsm:w-full xxsm:h-[280px] xxsm:mx-[5px] xxsm:object-contain z-0" />
              </ImageHover>
              {hoveredIndex === index && (
                <Slide
                  triggerOnce
                  direction="up"
                  className="absolute bottom-0 left-0 w-full h-[55px] xxsm:h-[40px] bg-[#CEAA77] z-[2]"
                >
