...
import img2 from "../assets/gallery/qc/03.jpg";
import img3 from "../assets/gallery/vshotel/06 VS.jpg";
...
export default [
  {
    ...
    imgUrl: img1,
    desc: `
    Las Casas Filipinas de Acuzar, situated in Bagac, Bataan, is a beach resort,
  ...
  },
  {
    ...
    imgUrl: img2,
    desc: `
    Las Casas Filipinas de Acuzar - Quezon City is the first venture under the Las
    ...
    well-loved Las Casas experience from Bataan into the metro.
            `,
  },
  {
    id: 2,
    ...
    imgUrl: img3,
    desc: `
    VS Hotel Convention Center is the ultimate destination for athletic enthusiasts
    ...
    and sports facilities to its guests.
            `,
  },
];
